...
If there's anything you need to do that's not covered below then raise an [Issue](https://github.com/jmg48/Kotlin.ScopeFunctions/issues) and we'll see about adding it!
...
Check out the test fixtures in `Kotlin.ScopeFunctions.Tests` and `Kotlin.ScopeFunctions.Dapper.Tests` for working examples of the full set of supported functionality.
